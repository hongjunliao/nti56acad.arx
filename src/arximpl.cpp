...
/////////////////////////////////////////////////////////////////////////////
	...
	ArxDbgDll_DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved);
	extern "C" __declspec(dllexport) AcRx::AppRetCode
	ArxDbgDll_acrxEntryPoint(AcRx::AppMsgCode msg, void* pPkt);
...
#ifndef ARXDBG_SHARED
	if(ArxDbgDll_acrxEntryPoint(msg, appId) != AcRx::kRetOK)
